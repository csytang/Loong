 ...
 * @since 3.0
 */
class CLRProjectionRulerColumn extends AnnotationRulerColumn {
	 ...
	 */
	public CLRProjectionRulerColumn(IAnnotationModel model, int width, IAnnotationAccess annotationAccess) {
	 ...
	 * @param annotationAccess the annotation access
	 */
	public CLRProjectionRulerColumn(int width, IAnnotationAccess annotationAccess) {
