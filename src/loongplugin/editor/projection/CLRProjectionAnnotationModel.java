...
public class CLRProjectionAnnotationModel extends AnnotationModel {
	/**
	 * Creates a new, empty projection annotation model.
	 */
	public CLRProjectionAnnotationModel() {
	}
	...
	public void collapse(Annotation annotation) {
		if (annotation instanceof CLRProjectionAnnotation) {
			CLRProjectionAnnotation projection = (CLRProjectionAnnotation) annotation;
	...
	public boolean collapseAll(int offset, int length) {
		...
		while (iterator.hasNext()) {
			CLRProjectionAnnotation annotation = (CLRProjectionAnnotation) iterator
					.next();
