	...
	public Object[] getChildren() {
		...
		if (fBinding != null) {
			...
			try {
				...
				LoongPlugin.log("Exception thrown in IBinding#getAnnotations() for \"" + fBinding.getKey() + "\"", e);
			}
			try {
				...
				res.add(new Error(this, label, e));
				LoongPlugin.log("Exception thrown in IBinding#getJavaElement() for \"" + fBinding.getKey() + "\"", e);
			}
			return res.toArray();
		}
		return EMPTY;
