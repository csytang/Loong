...
public class CASTDeleteHiddenNodesVisitor extends ASTVisitor {
	...
	public static String hideCode(String buffer, CompilationUnit ast, JDTColorManagerBridge nodeColors, Collection<Feature> visibleColors) throws JavaModelException, IllegalArgumentException {
	...
	public CASTDeleteHiddenNodesVisitor(ASTRewrite rewrite,JDTColorManagerBridge nodeColors,Collection<Feature> selectedColors) {
	...
	/**
	 * boolean value: return whether the ASTNode node should be returned;
	 * @param node
	 * @return
	 */
	...
	private void rewriteInfix(ASTNode node, InfixExpression parent,StructuralPropertyDescriptor prop, List<ASTNode> replacements) {
	...
	private ListRewrite getRewriteList(ASTNode parent, ChildListPropertyDescriptor descriptor) {
