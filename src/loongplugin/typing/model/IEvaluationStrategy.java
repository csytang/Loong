...
public interface IEvaluationStrategy {
	 ...
	 *         target
	 */
	boolean implies(FeatureModel featureModel, Set<Feature> source,
			Set<Feature> target);
	 ...
	 */
	boolean equal(FeatureModel featureModel, Set<Feature> source,
			Set<Feature> target);
	 ...
	 * @return true if source and target occur in exactly the same variants
	 */
	boolean equal(FeatureModel featureModel, Set<Feature> context,
	 ...
	 *         otherwise
	 */
	boolean areMutualExclusive(FeatureModel featureModel,
	 ...
	 */
	boolean mayBeMissing(FeatureModel featureModel, Set<Feature> context,
			List<Set<Feature>> featureSets);
