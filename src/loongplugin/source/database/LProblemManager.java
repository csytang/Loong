 ...
 */
class LProblemManager
{
	private LProblemManager() 
	{
	...
	{
		Bundle lJayFX = Platform.getBundle("Loong");
		assert( lJayFX != null );
		Platform.getLog( lJayFX ).log( new Status( IStatus.ERROR, "Loong", IStatus.OK, 
