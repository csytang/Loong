...
public class CommonEntityModel extends AbstractUMLEntityModel implements TypeEntityModel, StereoTypeModel, ICloneableModel {
	...
	public CommonEntityModel() {
		propertyDescriptors = new IPropertyDescriptor[] {
				new TextPropertyDescriptor(StereoTypeModel.P_STEREO_TYPE, LoongUMLPlugin.getDefault().getResourceString("property.stereoType")),
				new PropertyDescriptor(P_SIMPLE_ENTITY_NAME, LoongUMLPlugin.getDefault().getResourceString("property.simpleName")),
				new TextPropertyDescriptor(P_ENTITY_NAME, LoongUMLPlugin.getDefault().getResourceString("property.name")),
				new ColorPropertyDescriptor(P_BACKGROUND_COLOR, LoongUMLPlugin.getDefault().getResourceString("property.background")),
				new PropertyDescriptor(P_ATTRIBUTES, LoongUMLPlugin.getDefault().getResourceString("property.attributes")),
				new PropertyDescriptor(P_OPERATIONS, LoongUMLPlugin.getDefault().getResourceString("property.operations")) };
	}
