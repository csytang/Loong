...
import loongplugin.uml.UMLColorRegistry;
...
public abstract class AbstractUMLModel implements Serializable, IPropertySource {
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		return new IPropertyDescriptor[] {
				new ColorPropertyDescriptor(P_BACKGROUND_COLOR, LoongUMLPlugin
				...
				new BooleanPropertyDescriptor(P_SHOW_ICON, LoongUMLPlugin
