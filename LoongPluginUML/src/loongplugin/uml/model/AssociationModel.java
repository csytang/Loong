...
public class AssociationModel extends AbstractUMLConnectionModel implements
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		return new IPropertyDescriptor[] {
				new TextPropertyDescriptor(StereoTypeModel.P_STEREO_TYPE, LoongUMLPlugin
						.getDefault().getResourceString("property.stereoType")),
				new TextPropertyDescriptor(P_FROM_MULTIPLICITY, LoongUMLPlugin
						.getDefault().getResourceString(
								"property.multiplicityA")),
				new TextPropertyDescriptor(P_TO_MULTIPLICITY, LoongUMLPlugin
						.getDefault().getResourceString(
