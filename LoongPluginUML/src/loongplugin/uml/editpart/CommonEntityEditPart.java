...
import loongplugin.uml.classdiagram.figure.EntityFigure;
import loongplugin.uml.classdiagram.figure.UMLClassFigure;
import loongplugin.uml.model.AbstractUMLModel;
import loongplugin.uml.model.CommonEntityModel;
import loongplugin.uml.model.EntityModel;
...
public abstract class CommonEntityEditPart extends AbstractUMLEntityEditPart {
	...
	private boolean showSimpleName() {
		return LoongUMLPlugin.getDefault().getPreferenceStore().getBoolean(LoongUMLPlugin.PREF_CLASS_DIAGRAM_SHOW_SIMPLE_NAME);
	}
