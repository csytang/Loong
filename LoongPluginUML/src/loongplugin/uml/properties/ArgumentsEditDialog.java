package loongplugin.uml.properties;
...
public class ArgumentsEditDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		getShell().setText(LoongUMLPlugin.getDefault().getResourceString("argumentsDialog.title"));
		...
		column1.setText(LoongUMLPlugin.getDefault().getResourceString("argumentsDialog.label.argumentName"));
		column1.setWidth(120);

		TableColumn column2 = new TableColumn(table, SWT.LEFT);
		column2.setText(LoongUMLPlugin.getDefault().getResourceString("argumentsDialog.label.argumentType"));
		column2.setWidth(120);

		// ポップアップメニューを設定
		Menu menu = new Menu(table);
		add = new MenuItem(menu, SWT.PUSH);
		add.setText(LoongUMLPlugin.getDefault().getResourceString("argumentsDialog.menu.add"));
		...
		edit.setText(LoongUMLPlugin.getDefault().getResourceString("argumentsDialog.menu.edit"));
		...
		remove.setText(LoongUMLPlugin.getDefault().getResourceString("argumentsDialog.menu.remove"));
	...
	private class SingleArgumentDialog extends Dialog {
		...
		protected Control createDialogArea(Composite parent) {
			...
			getShell().setText(LoongUMLPlugin.getDefault().getResourceString("argumentDialog.title"));
			...
			label.setText(LoongUMLPlugin.getDefault().getResourceString("argumentDialog.label.argumentName"));
			...
			label.setText(LoongUMLPlugin.getDefault().getResourceString("argumentDialog.label.argumentType"));
