...
import loongpluginfmrtool.toolbox.bunch.BunchEvent;
import loongpluginfmrtool.toolbox.bunch.BunchFrame;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_AboutBox;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_clusteringMethodList_d_itemAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_clusteringOptionsButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_clusteringUtilsMenu_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_configureOptionsMenuItem_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_fileUtilsMenu_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_findLibraryNodesButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_findOmnipresentNodesButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_inputClusterFileSelectButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_menuFileExit_ActionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_menuHelpAbout_ActionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_nextLevelGraphButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_outputLastButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_queryNS_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_receiveFromCentralButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_receiveFromClientsButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_receiveFromSuppliersButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_receiveLibFromClientsButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_runActionButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_selectGraphFileButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_selectOutputFileButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_sendLibToClientsButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_sendToCentralButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_sendToClientsButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchFrame_sendToSuppliersButton_d_actionAdapter;
import loongpluginfmrtool.toolbox.bunch.BunchPreferences;
import loongpluginfmrtool.toolbox.bunch.Callback;
import loongpluginfmrtool.toolbox.bunch.CallbackImpl;
import loongpluginfmrtool.toolbox.bunch.ClusteringConfigurationDialog;
import loongpluginfmrtool.toolbox.bunch.ClusteringMethod;
import loongpluginfmrtool.toolbox.bunch.ClusteringProgressDialog;
import loongpluginfmrtool.toolbox.bunch.Configuration;
import loongpluginfmrtool.toolbox.bunch.DistribClusteringProgressDlg;
import loongpluginfmrtool.toolbox.bunch.DistributedHCClusteringMethod;
import loongpluginfmrtool.toolbox.bunch.GenericDistribHillClimbingClusteringMethod;
import loongpluginfmrtool.toolbox.bunch.GenericHillClimbingClusteringMethod;
import loongpluginfmrtool.toolbox.bunch.Graph;
import loongpluginfmrtool.toolbox.bunch.GraphOutput;
import loongpluginfmrtool.toolbox.bunch.GridBagConstraints2;
import loongpluginfmrtool.toolbox.bunch.HillClimbingConfiguration;
import loongpluginfmrtool.toolbox.bunch.MQCalculatorUtil;
import loongpluginfmrtool.toolbox.bunch.NAHCConfiguration;
import loongpluginfmrtool.toolbox.bunch.NextLevelGraph;
import loongpluginfmrtool.toolbox.bunch.Node;
import loongpluginfmrtool.toolbox.bunch.Parser;
import loongpluginfmrtool.toolbox.bunch.stats.StatsManager;
 ...
 */
	private void jbInit() throws Exception	{
		...
		preferences_d = (BunchPreferences)(Beans.instantiate(null, "loongpluginfmrtool.toolbox.bunch.BunchPreferences"));
 ...
 */
public void selectGraphFile(File file,String projectPath){
	String delims = delimEF.getText();
	 boolean state = spaceDelimCB.isSelected();
    ...
    String outputfilePath = projectPath+File.separatorChar+"bunch_clusteringresult";
    outputClusterFilename_d.setText(outputfilePath);
...
runActionButton_d_actionPerformed(ActionEvent e)
{
  ...
  if(doDistrib == true)
  {
     ...
     */
    loongpluginfmrtool.toolbox.bunch.LoadBalancer.Manager lbManager = new loongpluginfmrtool.toolbox.bunch.LoadBalancer.Manager();
    loongpluginfmrtool.toolbox.bunch.BunchServer.DistribInit diMsg = new loongpluginfmrtool.toolbox.bunch.BunchServer.DistribInit();
    ...
    if(activeServerVector!= null)
       for (int i = 0; i < activeServerVector.size(); i++)
       {
          ...
          byte[] so = loongpluginfmrtool.toolbox.bunch.util.BunchUtilities.toByteArray(diMsg);
          if (so != null)
          {
 ...
 *
 * @see #setLastResultGraph(loongpluginfmrtool.toolbox.bunch.Graph)
 */
public
Graph
getLastResultGraph()
...
void queryNS_actionPerformed(ActionEvent e) {
  ...
  {
    String msg =  loongpluginfmrtool.toolbox.bunch.util.BunchUtilities.DelimitString(excpt.toString(),25);
    JOptionPane.showMessageDialog(this,
...
{
  loongpluginfmrtool.toolbox.bunch.util.MeasurementUtil CalcUtil = new
  loongpluginfmrtool.toolbox.bunch.util.MeasurementUtil(this,"Calculator Utilility",true);
...
void ClearClusterFile_actionPerformed(ActionEvent e)
{
  ...
  lockClustersCheckbox_d.setEnabled(false);
	...
	void clusteringUtilsMenu_actionPerformed(ActionEvent e){
		  loongpluginfmrtool.toolbox.bunch.util.BunchClusteringUtil BunchUtil = new
		  loongpluginfmrtool.toolbox.bunch.util.BunchClusteringUtil(this,"Bunch Utilility",true);
	  ...
	  void fileUtilsMenu_actionPerformed(ActionEvent e) {
		  ...
		  loongpluginfmrtool.toolbox.bunch.util.BunchFileUtil BunchUtil = new
		  loongpluginfmrtool.toolbox.bunch.util.BunchFileUtil(this,"Bunch File Utilities",true);
	...
	public void setInputMDGFile(File file) {
		// TODO Auto-generated method stub
		inputGraphFilename_d.setText(file.getAbsolutePath());
	}
...
class BunchFrame_menuFileExit_ActionAdapter implements ActionListener{
	 ...
	 */
	class BunchFrame_selectGraphFileButton_d_actionAdapter implements java.awt.event.ActionListener{
	 ...
	 */
	class BunchFrame_selectOutputFileButton_d_actionAdapter implements java.awt.event.ActionListener{
	  BunchFrame adaptee;
	 ...
	 */
	class BunchFrame_configureOptionsMenuItem_d_actionAdapter implements java.awt.event.ActionListener{
		  BunchFrame adaptee;
