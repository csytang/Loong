...
import loongpluginfmrtool.statistic.a2a.Architecture2Architecture;
import loongpluginfmrtool.statistic.mojo.MoJoCalculator;

import org.eclipse.swt.widgets.Button;

public class Arch2ArchSettingUI extends TitleAreaDialog {
	 ...
	 * @param parentShell
	 */
	public Arch2ArchSettingUI(IProject pProject,Shell parentShell) {
		super(parentShell);
		aProject = pProject;
	...
	protected Control createDialogArea(Composite parent) {
		setTitle("Arch2Arch Setting Panel\n");
		...
		btnCompute.addListener(SWT.Selection, new Listener(){
			...
			public void handleEvent(Event event) {
				...
				if(combo.getSelectionIndex()!=-1){
					...
					// Collect Statistics
					Architecture2Architecture ar2ar = new Architecture2Architecture(recoveryResultTextContent.getText().trim(),groundTruthTextContent.getText().trim());
					double a2a = ar2ar.getArch2Arch();
					
					lblValue.setText(a2a+"");
				}
			}
