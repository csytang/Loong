package loongpluginfmrtool.toolbox.bunch.util;
...
public class BunchFileUtil extends JDialog {
  ...
  void ConvertPB_actionPerformed(ActionEvent e) {
      ...
      try
      {
        loongpluginfmrtool.toolbox.bunch.gxl.proxy.IMDGtoGXL converter =
          (loongpluginfmrtool.toolbox.bunch.gxl.proxy.IMDGtoGXL)oConv;
        if(embedDTD == true)
