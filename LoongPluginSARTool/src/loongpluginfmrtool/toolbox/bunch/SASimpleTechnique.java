...
import loongpluginfmrtool.toolbox.bunch.SASimpleTechniqueDialog;
...
extends SATechnique{
  ...
  public void reset()
  {
    stats = loongpluginfmrtool.toolbox.bunch.stats.StatsManager.getInstance();
  ...
  public boolean  accept(double dMQ)
  {
    ...
    if (loongpluginfmrtool.toolbox.bunch.util.BunchUtilities.compareGreaterEqual(dMQ,0.0))
      return false;
