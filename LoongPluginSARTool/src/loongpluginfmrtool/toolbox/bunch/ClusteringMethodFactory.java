...
ClusteringMethodFactory()
{
  ...
  addItem("Hill Climbing", "loongpluginfmrtool.toolbox.bunch.GeneralHillClimbingClusteringMethod");
  addItem("NAHC", "loongpluginfmrtool.toolbox.bunch.NextAscentHillClimbingClusteringMethod");
  addItem("SAHC", "loongpluginfmrtool.toolbox.bunch.SteepestAscentHillClimbingClusteringMethod");
  addItem("GA", "loongpluginfmrtool.toolbox.bunch.GAClusteringMethod");
  addItem("Exhaustive", "loongpluginfmrtool.toolbox.bunch.OptimalClusteringMethod");
}
