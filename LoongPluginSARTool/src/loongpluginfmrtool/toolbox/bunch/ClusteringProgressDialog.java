...
import loongpluginfmrtool.toolbox.bunch.DotGraphOutput;
import loongpluginfmrtool.toolbox.bunch.Drifters;
...
import loongpluginfmrtool.toolbox.bunch.IterationEvent;
import loongpluginfmrtool.toolbox.bunch.IterationListener;
import loongpluginfmrtool.toolbox.bunch.NextLevelGraph;
import loongpluginfmrtool.toolbox.bunch.OptimalClusteringMethod;
import loongpluginfmrtool.toolbox.bunch.RunMonitor;
 ...
 * @see loongpluginfmrtool.toolbox.bunch.ClusteringMethod
 * @see bunch.BunchFrame.runActionButton_d_actionPerformed(java.awt.event.ActionEvent)
 * @see loongpluginfmrtool.toolbox.bunch.BunchFrame
 */
public
...
loongpluginfmrtool.toolbox.bunch.SwingWorker worker_d;
...
public void startClustering()
{
   ...
   */
  worker_d = new loongpluginfmrtool.toolbox.bunch.SwingWorker()
  {
    ...
    public void finished()
    {
       ...
       */
      loongpluginfmrtool.toolbox.bunch.stats.StatsManager.cleanup();

      Configuration cTmp = clusteringMethod_x.getConfiguration();
      if(cTmp instanceof loongpluginfmrtool.toolbox.bunch.NAHCConfiguration)
      {
        loongpluginfmrtool.toolbox.bunch.NAHCConfiguration nahcConf = (loongpluginfmrtool.toolbox.bunch.NAHCConfiguration)cTmp;
