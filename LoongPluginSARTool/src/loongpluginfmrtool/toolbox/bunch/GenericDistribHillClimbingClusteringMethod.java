...
import loongpluginfmrtool.toolbox.bunch.GenericClusteringMethod2;
 ...
 *
 * @see loongpluginfmrtool.toolbox.bunch.NextAscentHillClimbingClusteringMethod
 * @see loongpluginfmrtool.toolbox.bunch.SteepestAscentHillClimbingClusteringMethod
 */
public abstract
...
private void manageDistribWorkIteration(String activity)
{
  ...
  byte[] so = loongpluginfmrtool.toolbox.bunch.util.BunchUtilities.toByteArray(im);
