...
import loongpluginfmrtool.toolbox.bunch.api.BunchStatsTest;
...
public class BunchStatsTest {
  ...
  public void checkGraphTest()
  {
    try
    {
      ...
      BunchPreferences pref = (BunchPreferences)(java.beans.Beans.instantiate(null, "bunch.BunchPreferences"));
