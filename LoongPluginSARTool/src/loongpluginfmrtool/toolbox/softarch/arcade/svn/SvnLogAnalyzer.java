package loongpluginfmrtool.toolbox.softarch.arcade.svn;
...
public class SvnLogAnalyzer {
    ...
    public static void main(String[] args) {
         ...
         * Default values:
         */
    	String url = "http://svn.apache.org/repos/asf/hadoop/common/tags/release-0.20.2"; // for older hadoop svn log
        //String url = "http://svn.apache.org/repos/asf/hadoop/common/trunk"; // for newer hadoop svn log
