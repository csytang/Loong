...
public class AlgorithmConfigurationUI extends TitleAreaDialog {
	 ...
	 * @param parentShell
	 */
	public AlgorithmConfigurationUI(Shell parentShell) {
		super(parentShell);
		instance = this;
	...
	public static AlgorithmConfigurationUI getDefault(Shell parentShell) {
		// TODO Auto-generated method stub
		if(instance == null){
			instance = new AlgorithmConfigurationUI(parentShell);
		}
		return instance;
	}
